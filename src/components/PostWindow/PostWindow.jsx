...
export default function PostWindow({
    ...
    useEffect(() => {
        ...
        api.getPostById(id)
            .then((data) => {
                setPostWindow(data)
                setReadyEditPost({title: data.title, text: data.text, image: data.image, tags: data.tags})
                                ...
                                <span className={s.headerRight}>
                                    ...
                                    {isAuthor && (
                                     editPost 
                                        ...
                                        : <div  className={s.btn} >
                                            <span className={s.edit} onClick={() => setEditPost(true)}><CreateOutlinedIcon/></span>
                                             <span className={s.delete} onClick={() => handleDelPost(id)}><DelBtn/></span>
                                        </div>)}
                                </span>
                            </div>
                        </div>
